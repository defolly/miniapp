...
import { CustomerItemPage } from '../pages/customer-item/customer-item';

import { SupperPage } from '../pages/supper/supper';
import { SupperItemPage } from '../pages/supper-item/supper-item';
